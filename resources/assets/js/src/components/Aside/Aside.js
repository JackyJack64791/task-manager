        ...
        <TabContent activeTab={this.state.activeTab}>
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-3">
              ...
              <div>Онлайн-встреча с заказчиком</div>
              <small className="text-muted mr-3"><i className="icon-calendar"></i>&nbsp; 13:00 - 15:00</small>
              <small className="text-muted"><i className="icon-social-skype"></i>&nbsp; Онлайн</small>
            </div>
            ...
            <div className="callout callout-info m-0 py-3">
              ...
              <div>Изменение полей формы</div>
              <small className="text-muted mr-3"><i className="icon-calendar"></i>&nbsp; 16:00 - 18:00</small>
              <small className="text-muted"><i className="icon-home"></i>&nbsp; Москва, офис</small>
            </div>
            <hr className="transparent mx-3 my-0"/>
            <div className="callout m-0 py-2 text-muted text-center bg-light text-uppercase">
              <small><b>Завтра</b></small>
            </div>
            <hr className="transparent mx-3 my-0"/>
            <div className="callout callout-danger m-0 py-3">
              <div>Разработка базы данных для <strong>Facebook</strong></div>
          ...
          <TabPane tabId="2" className="p-3">
            <div className="message">
              ...
              <div>
                <small className="text-muted">Петр Иванов</small>
                <small className="text-muted float-right mt-1">13:52</small>
              </div>
              <div className="text-truncate font-weight-bold">Разработка сайта</div>
              <small className="text-muted">Вам пришло предложение поучаствовать в проекте "Разработка сайта" от пользователя "Петр Иванов"
                Откройте сообщение для получения дополнительной информации
              </small>
            </div>
            <hr/>
            <div className="message">
              ...
              <div>
                <small className="text-muted">Петр Иванов</small>
                <small className="text-muted float-right mt-1">19:35</small>
              </div>
              <div className="text-truncate font-weight-bold">Приглашение в команду</div>
              <small className="text-muted">Петр Иванов приглашает вас в команду "AllStars". Для просмотра приглашения
                откройте сообщение.
              </small>
            </div>
            <hr/>
            <div className="message">
              ...
              <div>
                <small className="text-muted">Александр Васильев</small>
                <small className="text-muted float-right mt-1">21:52</small>
              </div>
              <div className="text-truncate font-weight-bold">Разработать модуль авторизации для CRM-системы</div>
              <small className="text-muted">Александр Васильев предлагает вам задание: разработать модуль авторизации для CRM-системы.
                Для принятия задания и просмотра сопроводительного письма, откройте сообщение.
              </small>
            </div>
            <hr/>
            {/*<div className="message">*/}
