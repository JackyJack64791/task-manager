          ...
          <Col>
            <Card>
              <CardBody>
                <Row>
                  <Col sm="5">
                    <CardTitle className="mb-0">Проекты</CardTitle>
                    <div className="small text-muted">Открытые</div>
                  </Col>
                ...
                <Row>
                  ...
                  <Table hover responsive className="table-outline mb-0 d-none d-sm-table">
                      ...
                      <tr>
                          ...
                          <th className="text-center">Метод выплаты</th>
                      ...
                      <tr>
                          ...
                          {/*</td>*/}
                          <td>
                              <div>Разработка CRM-системы</div>
                          ...
                          <td>
                              ...
                              <Progress className="progress-xs" color="success" value="5"/>
                          </td>
                          <td className="text-center">
                              <i className="fa fa-cc-mastercard" style={{fontSize: 24 + 'px'}}></i>
                          </td>
                          <td>
                              <div className="small text-muted">Последняя активность</div>
                              <strong>10 секунд назад</strong>
                          </td>
                      </tr>
                      <tr>
                          {/*<td className="text-center">*/}
                      ...
                      <tr>
                          ...
                          {/*</td>*/}
                          <td>
                              <div>Разработка мобильного приложения "Копеечница"</div>
                              {/*<div className="small text-muted">*/}
                                  {/*<span>New</span> | Registered: Jan 1, 2015*/}
                              {/*</div>*/}
                          </td>
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <Progress className="progress-xs" color="info" value="72"/>
                          </td>
                          <td className="text-center">
                      ...
                      <tr>
                          ...
                          <td>
                              ...
                              <Progress className="progress-xs" color="success" value="62"/>
                          </td>
                          <td className="text-center">
